...
const ru: SiteContent = {
    ...
    stats: [
      {
        ...
        suffix: "+",
        label: "лет опыта",
        description: "В высоконапорном литье алюминия",
      },
      {
        value: 700,
        suffix: " тыс.",
  ...
  about: {
    ...
    description: "",
    paragraphs: [
      "Невская Литейная Компания — российская компания, специализирующаяся на высоконапорном литье алюминия.",
  ...
  estimator: {
    ...
    materials: [
      ...
      { id: "ak8m", label: "АК8м" },
      { id: "ak8l", label: "АК8л" },
      { id: "ak8m3ch", label: "АК8М3ч" },
      { id: "ak9", label: "АК9" },
      { id: "ak9ch", label: "АК9ч" },
      { id: "ak9m2", label: "АК9М2" },
      { id: "ak12", label: "АК12" },
      { id: "ak12m2", label: "АК12М2" },
      { id: "ak45kd", label: "АК4,5Кд" },
